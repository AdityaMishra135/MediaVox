...
import org.skywaves.mediavox.core.compose.extensions.rateStarsRedirectAndThankYou
import org.skywaves.mediavox.core.compose.screens.*
import org.skywaves.mediavox.core.compose.theme.AppThemeSurface
import org.skywaves.mediavox.core.dialogs.ConfirmationAdvancedAlertDialog
...
class AboutActivity : ComponentActivity() {
    ...
    private fun launchEmailIntent() {
        ...
        val address = if (packageName.startsWith("org.skywaves")) {
    ...
    private fun onPrivacyPolicyClick() {
        val appId = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("org.skywaves.")
