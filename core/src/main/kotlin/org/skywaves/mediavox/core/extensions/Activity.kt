...
import org.skywaves.mediavox.core.compose.extensions.DEVELOPER_PLAY_STORE_URL
import org.skywaves.mediavox.core.databinding.DialogTitleBinding
import org.skywaves.mediavox.core.dialogs.*
import org.skywaves.mediavox.core.dialogs.WritePermissionDialog.WritePermissionDialogMode
import org.skywaves.mediavox.core.helpers.*
import org.skywaves.mediavox.core.models.*
import org.skywaves.mediavox.core.views.MyTextView
import java.io.*
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "org.skywaves.mediavox" || applicationId == "org.skywaves.mediavox.debug") {
                ...
                updateSDK30Uris(fileUris) { success ->
                    if (success) {
                        val values = ContentValues().apply {
                            put(MediaStore.Video.Media.DISPLAY_NAME, newPath.getFilenameFromPath())
                        }
