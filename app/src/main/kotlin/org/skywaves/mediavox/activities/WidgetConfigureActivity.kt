...
import org.skywaves.mediavox.databinding.ActivityWidgetConfigBinding
...
class WidgetConfigureActivity : SimpleActivity() {
    ...
    private fun initVariables() {
        ...
        if (mTextColor == resources.getColor(org.skywaves.mediavox.core.R.color.default_widget_text_color) && config.isUsingSystemTheme) {
            mTextColor = resources.getColor(org.skywaves.mediavox.core.R.color.you_primary_color, theme)
        }
        ...
        ensureBackgroundThread {
            ...
            if (path != null) {
                runOnUiThread {
                    ...
                    loadImageBase(path, binding.configImage, ROUNDED_CORNERS_NONE, signature)
                }
            }
        }
    }
