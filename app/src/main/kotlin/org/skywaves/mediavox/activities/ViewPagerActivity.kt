...
import org.skywaves.mediavox.adapters.MyPagerAdapter
import org.skywaves.mediavox.asynctasks.GetMediaAsynctask
import org.skywaves.mediavox.databinding.ActivityMediumBinding
import org.skywaves.mediavox.dialogs.DeleteWithRememberDialog
import org.skywaves.mediavox.dialogs.SlideshowDialog
...
class ViewPagerActivity : SimpleActivity(), ViewPager.OnPageChangeListener, ViewPagerFragment.FragmentListener {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, resultData: Intent?) {
       if (requestCode == REQUEST_VIEW_VIDEO && resultCode == Activity.RESULT_OK && resultData != null) {
    ...
    private fun getMediaForSlideshow(): Boolean {
        mSlideshowMedia = mMediaFiles.filter {
            (config.slideshowIncludeVideos && (it.isVideo() || it.isAudio()))
        }.toMutableList()
    ...
    private fun getChangeOrientationIcon(): Int {
        return if (mIsOrientationLocked) {
            if (requestedOrientation == ActivityInfo.SCREEN_ORIENTATION_PORTRAIT) {
                org.skywaves.mediavox.core.R.drawable.ic_orientation_portrait_vector
            } else {
                org.skywaves.mediavox.core.R.drawable.ic_orientation_landscape_vector
            }
        } else {
    ...
    private fun initBottomActionButtons() {
        ...
        binding.bottomActions.bottomShare.setOnLongClickListener { toast(org.skywaves.mediavox.core.R.string.share); true }
        ...
        binding.bottomActions.bottomDelete.setOnLongClickListener { toast(org.skywaves.mediavox.core.R.string.delete); true }
        ...
        binding.bottomActions.bottomProperties.setOnLongClickListener { toast(org.skywaves.mediavox.core.R.string.properties); true }
        ...
        binding.bottomActions.bottomToggleFileVisibility.setOnLongClickListener {
            toast(if (currentMedium?.isHidden() == true) org.skywaves.mediavox.core.R.string.unhide else org.skywaves.mediavox.core.R.string.hide); true
        }
    ...
    private fun updateBottomActionIcons(medium: Medium?) {
        ...
        val favoriteIcon =
            if (medium.isFavorite) org.skywaves.mediavox.core.R.drawable.ic_star_vector else org.skywaves.mediavox.core.R.drawable.ic_star_outline_vector
        binding.bottomActions.bottomFavorite.setImageResource(favoriteIcon)

        val hideIcon =
            if (medium.isHidden()) org.skywaves.mediavox.core.R.drawable.ic_unhide_vector else org.skywaves.mediavox.core.R.drawable.ic_hide_vector
    ...
    private fun askConfirmDelete() {
        ...
        val baseString = if (config.useRecycleBin && !config.tempSkipRecycleBin && !isInRecycleBin) {
            org.skywaves.mediavox.core.R.string.move_to_recycle_bin_confirmation
        } else {
    ...
    private fun refreshViewPager(refetchPosition: Boolean = false) {
        ...
        if (!isRandomSorting || isExternalIntent()) {
            GetMediaAsynctask(applicationContext, mDirectory, isPickVideo = false, isPickAudio = false, showAll = mShowAll) {
    ...
    private fun getPositionInList(items: MutableList<Medium>): Int {
        ...
        for ((i, medium) in items.withIndex()) {
           if (medium.path.equals(mPath, true)) {
                return i
            }
        }
        return mPos
            ...
            Intent().apply {
                ...
                try {
                    ...
                    if (!tryGenericMimeType(this, mimeType, newUri)) {
                        toast(org.skywaves.mediavox.core.R.string.no_app_found)
                    }
                } catch (e: Exception) {
                    showErrorToast(e)
                }
