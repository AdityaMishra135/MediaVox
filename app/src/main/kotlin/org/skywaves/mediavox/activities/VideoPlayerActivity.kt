...
import org.skywaves.mediavox.databinding.ActivityVideoPlayerBinding
...
open class VideoPlayerActivity : SimpleActivity(), SeekBar.OnSeekBarChangeListener, TextureView.SurfaceTextureListener {
    ...
    private fun videoPrepared() {
        if (!mWasVideoStarted) {
            ...
            if (config.autoplayVideos) {
                ...
                binding.bottomVideoTimeHolder.videoTogglePlayPause.setImageResource(org.skywaves.mediavox.core.R.drawable.ic_play_outline_vector)
            }
        }
    }
    ...
    private fun resumeVideo() {
        binding.bottomVideoTimeHolder.videoTogglePlayPause.setImageResource(org.skywaves.mediavox.core.R.drawable.ic_pause_outline_vector)
        if (mExoPlayer == null) {
            return
        }
