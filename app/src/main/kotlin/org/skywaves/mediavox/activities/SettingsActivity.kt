...
class SettingsActivity : SimpleActivity() {
            ...
            SecurityDialog(this, config.hiddenPasswordHash, tabToShow) { hash, type, success ->
                if (success) {
                    ...
                    if (config.isHiddenPasswordProtectionOn) {
                        ...
                        ConfirmationDialog(this, "", confirmationTextId, org.skywaves.mediavox.core.R.string.ok, 0) { }
                    }
                }
            }
        }
    ...
    private fun setupEmptyRecycleBin() {
        ...
        binding.settingsEmptyRecycleBinHolder.setOnClickListener {
            if (mRecycleBinContentSize == 0L) {
                toast(org.skywaves.mediavox.core.R.string.recycle_bin_empty)
            } else {
                ...
                ExportFavoritesDialog(this, getExportFavoritesFilename(), true) { path, filename ->
                    Intent(Intent.ACTION_CREATE_DOCUMENT).apply {
                        ...
                        try {
                            ...
                            toast(org.skywaves.mediavox.core.R.string.system_service_disabled, Toast.LENGTH_LONG)
                        } catch (e: Exception) {
                            showErrorToast(e)
                        }
                    }
    ...
    private fun exportFavoritesTo(outputStream: OutputStream?) {
        ...
        ensureBackgroundThread {
            ...
            if (favoritePaths.isNotEmpty()) {
                ...
                toast(org.skywaves.mediavox.core.R.string.exporting_successful)
            } else {
                toast(org.skywaves.mediavox.core.R.string.no_items_found)
            }
        }
    }
    ...
    private fun importFavorites(inputStream: InputStream?) {
        ...
        ensureBackgroundThread {
            ...
            toast(if (importedItems > 0) org.skywaves.mediavox.core.R.string.importing_successful else org.skywaves.mediavox.core.R.string.no_entries_for_importing)
        }
    }
    ...
    private fun parseFile(inputStream: InputStream?) {
        ...
        toast(if (configValues.size > 0) org.skywaves.mediavox.core.R.string.settings_imported_successfully else org.skywaves.mediavox.core.R.string.no_entries_for_importing)
        runOnUiThread {
            setupSettingItems()
        }
    }
