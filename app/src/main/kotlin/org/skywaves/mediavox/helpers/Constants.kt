...
const val LAST_PLAYED_TYPE= "last_played_type"
...
const val SHOW_THUMBNAIL_FILE_DIR = "show_thumbnail_file_dir"
const val SHOW_MEDIUM_FILE_SIZE = "show_medium_file_size"
...
const val SHOW_MEDIUM_SIZE = "show_medium_size"
...
const val GET_AUDIO_INTENT = "get_audio_intent"
...
const val TYPE_AUDIOS = 20000000

fun getDefaultFileFilter() = TYPE_VIDEOS or TYPE_AUDIOS
...
fun getPermissionToRequest() = if (isTiramisuPlus()) PERMISSION_READ_MEDIA_VIDEO else PERMISSION_WRITE_STORAGE
