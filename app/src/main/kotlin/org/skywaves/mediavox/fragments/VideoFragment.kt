...
import org.skywaves.mediavox.activities.VideoActivity
...
class VideoFragment : ViewPagerFragment(), TextureView.SurfaceTextureListener, SeekBar.OnSeekBarChangeListener {
    ...
    private fun getExtendedDetailsY(height: Int): Float {
        val smallMargin = context?.resources?.getDimension(org.skywaves.mediavox.core.R.dimen.small_margin) ?: return 0f
    ...
    fun playVideo() {
        ...
        if (!wasEnded || !mConfig.loopVideos) {
            mPlayPauseButton.setImageResource(org.skywaves.mediavox.core.R.drawable.ic_pause_outline_vector)
        }
    ...
    private fun pauseVideo() {
        ...
        mPlayPauseButton.setImageResource(org.skywaves.mediavox.core.R.drawable.ic_play_outline_vector)
